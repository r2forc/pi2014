...
public class RelatorioPorStatusUI extends JInternalFrame {
 ...
 public RelatorioPorStatusUI() {
  ...
  panel.setBorder(new TitledBorder(null, "Consulta", TitledBorder.LEFT, TitledBorder.TOP, null, null));
  ...
  groupLayout.setVerticalGroup(
   groupLayout.createParallelGroup(Alignment.LEADING)
    .addGroup(groupLayout.createSequentialGroup()
     .addContainerGap()
     .addComponent(panel, GroupLayout.PREFERRED_SIZE, 551, Short.MAX_VALUE)
     .addContainerGap())
  );
  ...
  jtfSelecaoCliente.setText("Selecione o Cliente.");
      ...
      .addGroup(gl_panel.createSequentialGroup()
       .addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
        ...
        .addGroup(gl_panel.createSequentialGroup()
         ...
         .addComponent(jtfSelecaoCliente, GroupLayout.PREFERRED_SIZE, 402, GroupLayout.PREFERRED_SIZE)
         .addGap(54)
   ...
   gl_panel.createParallelGroup(Alignment.LEADING)
    .addGroup(gl_panel.createSequentialGroup()
     ...
     .addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
      .addComponent(jtfSelecaoCliente, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
