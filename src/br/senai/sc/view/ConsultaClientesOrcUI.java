				...
				try {
					cli = (Cliente) new ClienteTableModel(
					 ...
					 new OrcamentoFlashControl().inserirCliente(cli);
						dispose();
				} catch (ClassNotFoundException | SQLException | ArrayIndexOutOfBoundsException e) {
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(jbSelecionar, GroupLayout.PREFERRED_SIZE, 219, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(jbCancelar, GroupLayout.PREFERRED_SIZE, 219, GroupLayout.PREFERRED_SIZE)))
